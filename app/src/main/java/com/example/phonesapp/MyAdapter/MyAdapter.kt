package com.example.phonesapp.MyAdapter
...
class MyAdapter(private val tags: ArrayList<String> , private var OnClickListiner : MyOnClickListiner) : RecyclerView.Adapter<MyAdapter.MyViewHolder>() {
